...
import fr.inra.mig_bibliome.stane.client.Edit.TextAnnotationCreationEdit;
...
import fr.inra.mig_bibliome.stane.client.data3.FragmentImpl;
...
// -----------------------------------------------------------------------------
    ...
    public void createMarkersForTargets(AnnotatedTextHandler annotatedDoc, AnnotationSchemaDefinition params, String newAnnotationType, List<Fragment> targets) {
        String annotationId = annotatedDoc.getNewAnnotationId();

        //store the new annotation id and its targets
        TextAnnotationCreationEdit annCreate = new TextAnnotationCreationEdit(annotatedDoc, annotationId, newAnnotationType, targets);
        annCreate.redo();
