...
import fr.inra.mig_bibliome.stane.client.Events.AnnotationStatusChangedEvent;
import fr.inra.mig_bibliome.stane.client.data3.AnnotatedTextImpl;
import fr.inra.mig_bibliome.stane.client.data3.AnnotatedTextProcessor.AnnotationFragmentMarkerMapper;
...
/**
 * This class is associated to one specific view, and keep track of the mapping between widget and the actual data.
 * @author fpapazian
 */
public class AnnotationDocumentViewMapper {
    ...
    public Annotation addAnnotation(String annotationId, String annotationType, Collection<Fragment> targets) {
        return annotatedTextHandler.addAnnotation(annotationId, annotationType, targets);
    }
    ...
    public Annotation addGroup(String annotationId, String groupType, List<Annotation> components) {
        return annotatedTextHandler.addGroup(annotationId, groupType, components);
    }

    public Annotation addGroup(String groupType, List<Annotation> components) {
        return annotatedTextHandler.addGroup(groupType, components);
    }
    ...
    public Annotation addRelation(String annotationId, String relationType, Map<String, Annotation> argumentRoleMap) {
        return annotatedTextHandler.addRelation(annotationId, relationType, argumentRoleMap);
    }

    public Annotation addRelation(String relationType, Map<String, Annotation> argumentRoleMap) {
        return annotatedTextHandler.addRelation(relationType, argumentRoleMap);
    }
