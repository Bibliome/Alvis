...
import fr.inra.mig_bibliome.stane.client.Config.History.StanePlaceHistoryMapper;
...
import fr.inra.mig_bibliome.stane.client.Events.ApplicationStatusChangedEventHandler;
 ...
 */
public class StaneBiotope implements EntryPoint {

    private static final String VERSION_LABEL = "v0.3 (build #1)";
    ...
    public void onModuleLoad() {
        ...
        if (" DEVMODE".equals("DEVMODE")) {
            ...
            defaultPlace = new DocSelectingPlace(null);
            ...
            //injector.getRequestManager().setServerBaseUrl("http://bibdev:8580/alvisae/pveber/api/");
