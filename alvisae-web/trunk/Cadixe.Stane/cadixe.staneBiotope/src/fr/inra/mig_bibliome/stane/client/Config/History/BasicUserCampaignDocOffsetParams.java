 ...
 * @author fpapazian
 */
public class BasicUserCampaignDocOffsetParams extends BasicUserCampaignDocParams implements UserCampaignDocPlaceUtils.UserCampaignDocOffsetParams {
    ...
    protected void parseToken(String token) {
        UserCampaignDocPlaceUtils.parseToken(token, new BasicUserCampaignDocOffsetParamsProcessor());
    }
}
