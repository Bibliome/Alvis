...
public interface ExtendedAnnotatedText {
     ...
     */
    Annotation createTextAnnotation(String id, String type, Collection<Fragment> fragments);
     ...
     * @throws IllegalArgumentException if the specified Annotation id is already in use
     */
    Annotation createGroupAnnotation(String id, String type, Collection<Annotation> components);
     ...
     * @throws IllegalArgumentException if the specified Annotation id is already in use
     */
    Annotation createRelationAnnotation(String id, String type, Map<String, Annotation> arguments);
