...
import fr.inra.mig_bibliome.stane.client.data.Queries.TermQueries;
import fr.inra.mig_bibliome.stane.client.data.Retrieve.AbstractRequestManager;
import fr.inra.mig_bibliome.stane.client.data.Retrieve.AbstractRequestManager.Entry;
...
public class TermDataProvider implements TermQueries {
    ...
    @Override
    public void addSynonymTogetSemanticClass(int projectId, int termId, int semClassId, int semClassVersion, AsyncCallback<SemClassNTermsImpl> resultCallback) {
        Entry[] params = new Entry[]{
    ...
    public String getTermExternalId(int projectId, int termId) {
        return requestManager.getServerBaseUrl() + "/projects/" + projectId + "/term/" + termId;
    }

    public String getSemClassExternalId(Integer projectId, int semClassId, int canonicTermId) {
        return requestManager.getServerBaseUrl() + "/projects/" + projectId + "/semClass/" + semClassId + "/canonic/" + canonicTermId;
    }
}
