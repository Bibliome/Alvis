...
import fr.inra.mig_bibliome.stane.client.data3.SemClassImpl;
import fr.inra.mig_bibliome.stane.shared.data3.SemClass;
import fr.inra.mig_bibliome.stane.shared.data3.SemClassNTerms;
import fr.inra.mig_bibliome.stane.shared.data3.SemClassTreeLevel;
