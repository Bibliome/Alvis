...
import fr.inra.mig_bibliome.stane.client.Events.TargetSelectionChangedEvent;
import fr.inra.mig_bibliome.stane.client.Events.TargetSelectionChangedEventHandler;
