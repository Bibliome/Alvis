 ...
 * @author fpapazian
 */
public class BasicUserCampaignDocParams implements UserCampaignDocPlaceUtils.UserCampaignDocParams {
    ...
    protected void parseToken(String token) {
        UserCampaignDocPlaceUtils.parseToken(token, new BasicUserCampaignDocParamsProcessor());
    }
}
