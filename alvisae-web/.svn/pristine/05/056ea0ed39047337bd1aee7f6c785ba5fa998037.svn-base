...
import fr.inra.mig_bibliome.stane.client.Events.InformationReleasedEventHandler;
...
import fr.inra.mig_bibliome.stane.client.Events.MaximizingWidgetEvent;
...
import fr.inra.mig_bibliome.stane.client.Events.MaximizingWidgetEventHandler;
...
/**
 * Main UI of the Annotation Editor, it contains
 *  - a document editor panel,
 *  - a table of all annotations of the current document,
 *  - a property grid for the selected annotation
 *  - a tool bar allowing to navigate through the documents of the campaign
 * 
 * @author fpapazian
 */
