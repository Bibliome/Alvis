 ...
 *
 */
package fr.inra.mig_bibliome.stane.client.data.Queries;
...
public interface TermQueries {
    ...
    void addSynonymTogetSemanticClass(int projectId, int termId, int semClassId, int semClassVersion, AsyncCallback<SemClassNTermsImpl> resultCallback);
