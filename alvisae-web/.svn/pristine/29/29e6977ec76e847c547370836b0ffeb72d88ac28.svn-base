...
import fr.inra.mig_bibliome.stane.client.Config.ApplicationOptions;
...
import fr.inra.mig_bibliome.stane.shared.data3.Queries.AuthenticationQueries;
...
public abstract class AbstractRequestManager implements AuthenticationQueries {
    ...
    //
    protected static String NOOPREQUEST_URL = "AlvisAE_NoOpRequest";
    //--------------------------------------------------------------------------
     ...
     * @param params optional request data (PUT, POST)
