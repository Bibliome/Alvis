...
import fr.inra.mig_bibliome.stane.client.data3.ExtendedUserInfoImpl;
import fr.inra.mig_bibliome.stane.client.data3.UserAuthorizationsImpl;
...
public class RequestManager extends AbstractRequestManager {
    ...
    public void resetAuthenticationInfoAdminStatus(boolean isAdmin) {
