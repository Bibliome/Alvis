...
import fr.inra.mig_bibliome.stane.client.SemClass.CellFactory.AbstractTermCell;
import fr.inra.mig_bibliome.stane.client.SemClass.CellFactory.SemClassNodeInfo;
import fr.inra.mig_bibliome.stane.client.SemClass.CellFactory.TermNodeInfo;
