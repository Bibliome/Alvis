    ...
    public Tester() {
        ...
        filePathList.addChangeHandler(new ChangeHandler() {
            ...
            public void onChange(ChangeEvent event) {
                ...
                if (f.isEmpty()) {
                    documentUI.setDocument((String)null, new DocumentUi.Options(true, false, true, true, true, null));
                } else {
    ...
    private void fileLoaded(String method, String url, String content) {
        if (content == null || content.trim().isEmpty()) {
            ...
            if ("LIST".equals(method)) {
                ...
                documentUI.setDocument(content, new DocumentUi.Options(false, false, false, false, false, null));
            }
        }
