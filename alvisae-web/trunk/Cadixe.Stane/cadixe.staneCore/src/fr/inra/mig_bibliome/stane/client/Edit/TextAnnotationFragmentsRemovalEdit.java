...
/**
 * Specialized Edit corresponding to the removal of fragments from an existing Annotation.
 * @author fpapazian
 */
public class TextAnnotationFragmentsRemovalEdit extends AnnotationEdit implements TextAnnotationCoverageEdit {
