...
public interface AnnotationGroup {
     ...
     */
    void addComponent(Annotation component);
     ...
     * @throws NullPointerException if component is null
     */
    void removeComponent(Annotation component);
     ...
     */
    void addComponents(Collection<Annotation> components);
     ...
     * @throws NullPointerException if components is null
     */
    void removeComponents(Collection<Annotation> components);
}
