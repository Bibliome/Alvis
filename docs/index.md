...
1. _AlvisAE_: an annotation editor [git repo](https://github.com/bibliome/Alvis/)

2. _AlvisNLP_: a text-mining workflow engine [git repo](https://github.com/bibliome/AlvisNLP/)
     
1. _AlvisIR_: a search engine interface enabling to explore text-mining results [git repo](https://github.com/bibliome/AlvisIR/) /  [demo instance](http://bibliome.jouy.inra.fr/demo/ontobiotope/alvisir2/webapi/search)<!--  ![AlvisIR screenshot]() -->
